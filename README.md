...
- [x] What are PropTypes used for? Please describe why it's important to type check our data in JavaScript.
    PropTypes are used to check what data is being passed. It is important to check what our types are, because we don't want numbers where stings should be, or empty data that could break our code.
- [x] Describe a life-cycle event in React?
    The three main parts are mount, update, and unmount.
- [x] Explain the details of a Higher Order Component?
    Higher Order Components are like higher order functions. The are used to build components that share the same logic.
